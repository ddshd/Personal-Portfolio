...
<head>
  <?php $title = "Privacy & GDPR Policy"; ?>
  <?php include 'extras/meta.php'; ?>

  <?php function descriptionTag()
  {
    echo "Privacy & GDPR Policy.";
  }  ?>

  <?php
  $scheme = ['#bfb5d7', '#2d1fe8'];
  ?>
  ...
  <style>
    ...
    hr {
      border-color: <?php echo $scheme[1]; ?>;
    }
...
<body>
  <div class="body-container">
    ...
    <p>Your privacy is important to us. It is Dhrumil Shah&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a style="text-decoration: none;" href="https://<?php echo $_SERVER['HTTP_HOST']; ?>">https://<?php echo $_SERVER['HTTP_HOST']; ?></a>, and other sites we own and operate. </p>
    ...
    <h3>Contact Me</h3>
    <p>For any questions or concerns regarding your privacy, you may contact me using the details on the homepage.</p>

    <hr>

    <h2>GDPR Policy</h2>
    <p>Unfortunately, this website is unavailable within the EU.</p>
