...
<head>
  ...
  <?php function descriptionTag() { echo "Fight against injustice and police brutality."; }  ?>
...
<style>
    html {
      ...
      background-image: url(<?php echo '"'; localDevEnvironment(); echo '/img/injustice/fist.png"';?>);
...
<center>
  ...
  <form action="<?php localDevEnvironment(); echo '/'?>" method="get" target="_self">
